'''
The Keras-compatible loss function for the SSD weights. Currently supports TensorFlow only.
...
class SSDLoss:
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            n_neg_min (int, optional): The minimum number of negative ground truth boxes to
                ...
                sure that the weights learns from a minimum number of negatives in batches
    ...
    def smooth_L1_loss(self, y_true, y_pred):
        ...
        Arguments:
            y_true (nD tensor): A TensorFlow tensor of any shape containing the ground truth insight_data.
                In this context, the expected tensor has shape `(batch_size, #boxes, 4)` and
                contains the ground truth bounding box coordinates, where the last dimension
                contains `(xmin, xmax, ymin, ymax)`.
            y_pred (nD tensor): A TensorFlow tensor of identical structure to `y_true` containing
                the predicted insight_data, in this context the predicted bounding box coordinates.
    ...
    def log_loss(self, y_true, y_pred):
        ...
        Arguments:
            ...
            y_pred (nD tensor): A TensorFlow tensor of identical structure to `y_true` containing
                the predicted insight_data, in this context the predicted bounding box categories.
    ...
    def compute_loss(self, y_true, y_pred):
        '''
        Compute the loss of the SSD weights prediction against the ground truth.

        Arguments:
            y_true (array): A Numpy array of shape `(batch_size, #boxes, #classes + 12)`,
                where `#boxes` is the total number of boxes that the weights predicts
            ...
            y_pred (Keras tensor): The weights prediction. The shape is identical
        ...
        def f2():
            ...
            # belong to the background class in the ground truth insight_data. Note that this doesn't necessarily mean that the weights
